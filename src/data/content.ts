...
export const projectContent = {
  ...
  "about": {
    "title": "Bridging the Gap Between Policy and Action",
    "values": [
    ...
    "description": "Founded to revolutionize strategic consulting, PIRAEUS Group Limited has grown into a leading agency known for excellence, innovation, and integrity. We bridge the gap between international policy objectives and effective project implementation.",
    "purposeTitle": "OUR MANDATE",
    "purposeDescription": "We provide end-to-end consulting solutions that support public institutions, contractors, and private sector partners in planning, managing, and successfully executing government and private sector projects."
  },
  "ethics": {
    ...
    "services": [
      {
        "id": "gov-consulting",
        "icon": "Landmark",
        "image": "/images/templates/oceania/service-gov.png",
        "title": "Government Strategic Consulting",
        "description": "Helping public sector organizations achieve efficiency and transparency through policy development."
      },
      {
        "id": "financial-excellence",
        "icon": "BarChart3",
        "image": "/images/templates/oceania/service-finance.png",
        "title": "Financial Excellence",
        "description": "Corporate and government financial solutions focusing on audits, compliance, and process optimization."
      },
      {
        ...
        "description": "Tailored solutions to protect, grow, and transfer wealth effectively for individuals and institutions."
      },
      {
        ...
        "description": "Professional consulting for solar and wind projects, including feasibility studies and technical advisory."
      },
      {
        "id": "scrap-metal",
        "icon": "Recycle",
        "image": "/images/templates/oceania/service-recycling.png",
        "title": "Scrap Metal Recycling",
        "description": "Promoting a circular economy through industrial scrap collection, processing, and environmental compliance."
      },
      {
        "id": "advisory-risk",
        "icon": "ShieldAlert",
        "image": "/images/templates/oceania/service-risk.png",
        "title": "Advisory & Risk Management",
        "description": "Corporate governance advisory, risk assessment, and compliance solutions for sustainable growth."
      }
    ],
